        ...
        <div className="grid gap-14 lg:grid-cols-2 lg:gap-20">
          <div>
            ...
            <dl className="mt-10 grid grid-cols-2 gap-x-6 gap-y-8 sm:max-w-md">
              <Stat value="18" label="محافظة مشمولة" delay={0} />
              <Stat value="+10" label="مجالات استشارية" delay={0.08} />
              <Stat value="100%" label="استشارة مستقلة" delay={0.16} />
              <Stat value="2026" label="سنة التأسيس" delay={0.24} />
            </dl>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {values.map((v, i) => {
              ...
              return (
                <Reveal
                  key={v.title}
                  delay={(i % 2) * 0.08 + Math.floor(i / 2) * 0.08}
